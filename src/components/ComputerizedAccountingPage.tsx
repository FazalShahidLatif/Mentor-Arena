...
const heroAccountingImg = '/assets/images/hero_financial_excel_1786510102786.webp';
  ...
  return (
    <div className="bg-white text-gray-900 selection:bg-blue-600/10 selection:text-blue-900" id="accounting-course-view">
      ...
      <HeroBanner
        ...
        image={{
          src: '/assets/images/hero_financial_excel_1786510102786.webp',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="my-16">
          <RecommendedPaths 
            currentTrack="computerized-accounting" 
